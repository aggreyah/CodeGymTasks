...
public class Solution {
    ...
    public static boolean isModifierSet(int allModifiers, int specificModifier) {
        List<String> allString = Arrays.asList(Modifier.toString(allModifiers).split(" "));
        List<String> specificString = Arrays.asList(Modifier.toString(specificModifier).split(" "));
        if (allString.containsAll(specificString))
            return true;
        else
            return false;
    }
