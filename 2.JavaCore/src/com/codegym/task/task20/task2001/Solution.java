...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File yourFile = File.createTempFile("task2001OutPut", ".txt");
            ...
            System.out.println("other person is smith => " + somePerson.equals(smith));
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String hasAssets = assets.isEmpty()?"no":"yes";
            PrintWriter writer = new PrintWriter(outputStream);
            writer.println(this.name);
            writer.println(hasAssets);
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if (hasAssets.equals("yes")){
                while (reader.ready()){
                    ...
                    Asset currentAsset = new Asset(name, price);
