...
public class Solution {
    public static void main(String[] args) {printMatrix(2, 3, "8");}
    ...
    public static void printMatrxix(int m, int n, Short value){
    ...
    public static void printMatrxix(int m, int n, Boolean value){
